...
function getRootFreq(key: string): number {
...
function generateMelody(rootFreq: number, scale: number[], bars: number, bpm: number, seed: number): number[] {
...
function generateWaveform(freq: number, sampleIndex: number, sampleRate: number, waveform: string): number {
...
export function generateTrack(params: SynthParams): SynthOutput {
...
export function exportWav(audio: Float32Array, sampleRate: number): Buffer {
